...
import com.mjhram.geodata.common.IntentConstants;
...
public class GpsLoggingService extends Service  {
    ...
    private void ShowNotification() {
        ...
        String contentText = getString(R.string.geodata_still_running);
    ...
    private void WriteToFile(MyInfo loc) {
        ...
        try {
            ...
            if(prevLocation == null) {
                UploadClass.updateLoc(loc);
                prevLocation = new Location(loc.loc);
            } else {
                if(prevLocation.getTime() == loc.loc.getTime()){
                    //same location=>don't update
                    if(prevLocation.getAccuracy() > loc.loc.getAccuracy()) {
                        prevLocation.set(loc.loc);
                    }
                } else {
                    UploadClass.updateLoc(loc);
                    prevLocation.set(loc.loc);
